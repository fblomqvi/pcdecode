...
#define lcheck(c, label, msg, ...) \
	lcheck_pf(c, log_err, label, msg, ## __VA_ARGS__)

#define lcheck_dbg(c, label, msg, ...) \
	lcheck_pf(c, debug_err, label, msg, ## __VA_ARGS__)

#define llibcheck(c, label, msg, ...) \
	llibcheck_pf(c, debug_err, label, msg, ## __VA_ARGS__)
